const imageIllustration = "/images/courses-comparison/newsletter-illustration.png";
const element1 = "/images/event-details/element-message-1.png";
const element2 = "/images/event-details/element-message-2.png";
const element3 = "/images/event-details/element-message-3.png";
const element4 = "/images/event-details/element-message-4.png";
          ...
          <div className="padding-t-80 padding-b-80 col-start-6 col-end-13 xxl:col-start-7">
            ...
            <FadeRight>
              <p className="lText mt-6 text-neutral-500">
                Embark on a journey of discovery with Eduvate University.
