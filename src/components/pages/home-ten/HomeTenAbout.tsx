const about = "/images/home-ten/about.png";
const image1 = "/images/home-ten/global-courses.png";
const image3 = "/images/home-ten/marketing.png";
const image2 = "/images/home-ten/primary-school.png";
  ...
  const infoData = [
    {
      ...
      text: "Eduvate Abroad offers a diverse range of study programs designed to immerse students in global learning experiences.",
    },
    {
      image: image2,
    ...
    },
    {
      ...
      text: "Beyond academics, Eduvate Abroad focuses on holistic development. Our programs emphasize the development",
    },
  ];
  return (
    <div className="overflow-x-clip">
      ...
      <div className="container section-gap-top section-gap-bottom grid-cols-12 items-center gap-6 lg:grid">
        <div className="col-start-1 col-end-7">
          <D4>Welcome to Eduvate Abroad</D4>
          <TextL className="pt-6">
            Welcome to Eduvate Abroad, where we believe that education knows no
