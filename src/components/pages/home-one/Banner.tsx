const bannerImage = "/images/homeOne/banner-image.png";
const bannerSmallImage = "/images/homeOne/banner-small-image.png";
const bannerSun = "/images/homeOne/banner-sun.png";
