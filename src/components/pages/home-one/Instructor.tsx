const arrow = "/images/homeOne/instructor-element-arrow.png";
const dollar = "/images/homeOne/instructor-element-dollar.png";
const instructor = "/images/homeOne/instructor.png";
            ...
            <div className="col-start-7 col-end-13 py-10 lg:py-20">
              ...
              <FadeLeft>
                <p className="lText mt-6 text-neutral-500">
                  ...
                  on Eduvate. We provide the tools and skills to teach what you
                  love.
                </p>
              </FadeLeft>
              <div className="mt-10">
