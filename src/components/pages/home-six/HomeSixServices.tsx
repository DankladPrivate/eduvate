const bookVideoIcon = "/images/home-six/book-video-icon.png";
const book = "/images/home-six/book.png";
const education = "/images/home-six/education.png";
const records = "/images/home-six/worlds-records.png";
    ...
    <div className="bg-neutral-20 section-gap-top section-gap-bottom overflow-hidden">
      <div className="container">
        <SectionHeading
          ...
          description="Explore the philosophy that drives Eduvate, shaping an educational ecosystem that values curiosity, collaboration"
          link="/"
