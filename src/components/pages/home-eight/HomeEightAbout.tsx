const icon1 = "/images/home-eight/about-education.png";
const aboutImage1 = "/images/home-eight/about-image-1.png";
const aboutImage2 = "/images/home-eight/about-image-2.png";
const icon3 = "/images/home-eight/about-inovation.png";
const icon4 = "/images/home-eight/about-worlds-records.png";
const icon2 = "/images/home-eight/icon5.png";
const userImage = "/images/home-eight/user-image.png";
    ...
    <div className="container section-gap-top section-gap-bottom overflow-hidden">
      <div className="grid-cols-12 items-center justify-between gap-6 lg:grid">
        ...
        <div className="col-start-7 col-end-13 max-lg:padding-t-60">
          <FadeLeft>
            <D4>Welcome to Eduvate University</D4>
          </FadeLeft>
          <FadeRight>
            <TextL className="pt-6">
              At Eduvate University, our mission is to empower minds, inspire
          ...
          <div className="padding-t-60 gap-40px flex flex-col">
            <div className="gap-32px grid-cols-2 max-xxl:flex max-xxl:flex-col xxl:grid">
              <HomeEightAboutInfo
                ...
                text="Eduvate University is renowned for its commitment "
              />
              <HomeEightAboutInfo
                image={icon2}
