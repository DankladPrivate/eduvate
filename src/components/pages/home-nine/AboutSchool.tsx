const primarySchool = "/images/home-nine/about-primary-school.png";
const sectionImage = "/images/home-nine/about-section.png";
const programmingLanguage = "/images/home-nine/programing-language.png";
const videoTutorial = "/images/home-nine/video-tTutorials.png";
    ...
    <div className="bg-neutral-20 section-gap-top section-gap-bottom overflow-hidden">
      <div className="container grid-cols-12 items-center gap-6 md:grid">
        ...
        <div className="col-start-7 col-end-13 flex flex-col max-xxl:padding-t-80">
          <BannerInspireText />
          <FadeLeft>
            <D4 className="pt-4">Welcome to Eduvate Schools</D4>
          </FadeLeft>
          <div className="gap-40px flex flex-col  pt-6">
            <FadeRight>
              <TextL>
                At Eduvate School, we are more than just an educational
            ...
            <FadeLeft className="gap-32px flex flex-col">
              ...
              <HomeEightAboutInfo
                ...
                text="At Eduvate School, we believe in the power of exceptional educators. "
              />
              <HomeEightAboutInfo
                image={videoTutorial}
                title="Extracurricular Excellence"
                text="Beyond academics, Eduvate School offers a vibrant array of extracurricular activitie"
              />
            </FadeLeft>
            <BorderHorizontal />
            <Fade>
